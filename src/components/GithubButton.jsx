...
export default function GithubButton() {
    ...
    useEffect(() => {
      fetch('https://api.github.com/repos/KloutDevs/BottleBrandingPage')
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center">
          ...
          <span className="ml-1 text-white">Ver en GitHub</span>
        </div>
